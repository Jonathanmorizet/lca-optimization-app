...
# The rest of the logic is already shown fully in the previous assistant message. 
# Replace this placeholder with the actual content of that full Streamlit code.

# Please refer to that for the full functionality.
